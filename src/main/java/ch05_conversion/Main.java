...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("변형 : " + (int)cast1);       // A의 아스키 코드 값 = 65

        char cast2 = 'a';
        System.out.println("원형 : " + cast2);
        System.out.println("변형 : " + (int)cast2);       // a의 아스키 코드 값 = 97 * 외우기

        // 업캐스팅 방법 #2
        // 새로운 변수를 선언하여 캐스팅이 이루어진 데이터를 집어넣는 방법입니다.
        char cast3 = 'b';
        int casted3 = cast3;        // 여기서는 int로 안쓰였죠
        ...
        int cast4 = 99;         // 얘는 #1으로,
        int cast5 = 100;        // 얘는 #2로
        // 지시 사항 : 다운캐스팅 하는 방법을 업캐스팅 방법 #1, 2 를 참조하여 char 형으로 바꾼 후
        ...
        /*
            ...
            경우가 있습니다.
            (아까 강남스타일을 예시로 들었을 때 30억 넘는 숫자를 다시 int로 형변환하게 되면 마이너스 값이
            나오게 되겠죠)
