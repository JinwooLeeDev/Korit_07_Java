...
//        animal2.fetch();          // 불가능
        ...
        // anumal3의 경우 Animal animal3 = new Animal();로 생성했습니다.
...
//        Dog dog3 = (Dog) animal3;   // downcasting 을 하는 과정에서 오류가 발생함
//        dog3.makeSound();   // 그러니까 얘는 지금 호출도 못해보는 상황입니다.
        ...
        if(animal4 instanceof Dog) {        // 이 조건식이 true 라면 animal4의 생성 시 호출된 생성자는 Dog();
            Dog dog4 = (Dog) animal4;       // 그러므로 91번 라인의 실행문을 통해 다운캐스팅을 하더라도 오류 발생 x
            dog4.makeSound();
            dog4.fetch();
        }
