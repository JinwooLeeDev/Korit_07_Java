...
public class PersonMain {
    public static void main(String[] args) {
        ...
        // Setter / Getter의 사용법 -> 얘내는 method라고 했습니다.
        ...
        // Setter / Getter을 통해서만 데이터의 입력 / 수정 / 조회를 가능하게 하고
        ...
        // 이상과 같은 코드 라인을 특정 방법을 사용하면 부정확한 데이터의 입력이 가능
        ...
        // . . 이 여러 개 나오는 방식을 chaining 이라고 합니다.
