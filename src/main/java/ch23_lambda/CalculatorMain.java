...
public class CalculatorMain {
    ...
    public static void main(String[] args) {
        ...
        Calculator add = (int x, int y) -> x + y;   // Calculator 인터페이스의 객체명이 add고, 내부 메서드는 calculate()
        Calculator sub = (int x, int y) -> x - y;   // Calculator 인터페이스의 객체명이 sub고, 내부 메서드는 calculate()
