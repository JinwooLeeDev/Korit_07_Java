    ...
    3. 메서드
        1) Setter / Getter
            특히 Setter의 경우에는 유효성 검증 로직을 삽입해야 함.
                -> 잔액은 음수일 수 없음
                -> 비밀번호는 0 이상 9999 이하까지만 가능. 0> 실패하면 "불가능한 비밀번호입니다."
...
public class Bank {
    ...
    public void withdraw(int amount, int inputPin) {
        ...
        if((balance-amount) < 0) {
            ...
            System.out.println("현재 잔액은 " + (balance - amount) + "원 입니다.");
    ...
    public void setPinNumber(int pinNumber) {
        if (pinNumber<0&&pinNumber>9999) {
            System.out.println("불가능한 비밀번호 입니다. 다시 입력하세요");
    ...
    public void showAccount() {
        ...
        System.out.println("계좌 잔액 : " + getBalance());
    }
}
