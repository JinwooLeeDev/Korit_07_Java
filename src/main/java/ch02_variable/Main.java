...
/*
    주석 (comment) : Java 프로그램의 경우 폴더 및 파일의 전체 코드를 컴파일링 하는데
        ...
        하지만 주석 처리를 한 부분에 대해서는 컴퓨터가 코드를 인지하지 않기 때문에
        오류가 발생하지 않습니다.
        ...
        3) 사후주석 : 주석 처리할 부분의 코드 라인에 ctrl + / (Mac : command + /)
 */
public class Main {
    public static void main(String[] args) {
        System.out.println("안녕하세요, 제 이름은 이진우입니다.");
//        System.out.println(안녕하세요, 제 이름은 이진우입니다.);
        System.out.println(1);
        System.out.println('1');
        System.out.println("1");
        /*
            이상과 같으 방식의 코드 대입을 (매번 데이터를 직접 사용하는 방식)
            하드 코딩이라는 표현을 씁니다.
        ...
        char name2 = '진';
        char name3 = '우';
        System.out.println(name1+name2+name3);  // 결과값 : 153576
        System.out.println('이' + '진' + '우');  // 결과값 : 153576

        System.out.println("" + name1 + name2 + name3); // 결과값 : 이진우

        /*
            이상의 코드에서 알 수 있는 점은 컴퓨터가 생각보다 멍청하다.
            개발자인 저희가 하나하나 지정을 해줘야 한다는 점입니다.
            '문자'와 '문자열'은 서로 다른 개념인데,
            문자(하나짜리)를 세 번 더했을 경우에는 더 이상 문자가 아니라 문자열로 인식되기
            때문에 원하는 방식으로 출력되지 않습니다. 153 어쩌고로 출력됐죠

            그렇기 때문에 73번 라인에서 sout()의 () 내부에 ""를 넣어주니까,
            원하는 결과값을 얻을 수 있었습니다.

            즉
            작은따옴표('')는 '문자'를 푯기하기 위한 기호
            큰따옴표("")는 "문자열"를 표시하기 위한 기호
            라고 알아두시면 되겠습니다.(근데 python이랑 JavaScript에서는 또 이런 구분이
            없습니다.)
        ...
        /*
            ...
            제 전공은 어쩌고 저쩌고 학과이며, mbti는 블라블라입니다. 열심히 할게요 !!!
        ...
        // enter 키 위에 원화 표시 있습니다. 원화표시가 한국에서만 먹히는 형태고 원래는 역슬러시만 표기되어 있습니다.
        // \n -> 개행이 일어납니다.
        // \t -> 탭 친 효과가 일어납니다.

        System.out.println("저는 코리아 it 아카데미 7월 국비과정을 수강하고 있는 " + name10 + "입니다.\n" + "제 전공은 " + major10
            + "이고 mbti는 " + mbti10 + "입니다. 열심히 할게요 !!!");
