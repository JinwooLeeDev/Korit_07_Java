...
/*
    ...
    일반 for 문과의 차이점 :
        ...
        이름 응용하여 배열 내의 element에 for문 내부에서만 사용하는 변수에 대입하는
        방식으로 index 넘버(주소지)의 사용없이 적응할 수 있는 for 반복문이 있는데,
        이를 향상된 for문이라고 합니다.
...
public class Array10EnhancedFor {
    public static void main(String[] args) {
        ...
        for (int number : nums ) {  // int[]
            ...
            // 대입이 된 상태로 39번 라인을 실행시킵니다. "1 " 까지 출력 됩니다.
            // 그 다음 반복으로 넘어가서 nums의 두 번째 element인 2를 number에 대입
            // 39번 실행
            // 다음 3 대입
            // 39 실행
            // ... 200 대입
            // 39번 라인 실행 하고, 마무리(마무리 시점은 마지막 element 대입 후
            // 반복 실행문 실행 후)
